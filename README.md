[![Blagues API](https://raw.githubusercontent.com/DraftProducts/blagues-api/master/src/public/Logo.200.png)](http://blagues-api.fr)
# Blagues API
...
Avant toute utilisation de l'api veuillez générer votre token Bearer depuis la page **account** site [blagues-api.fr](https://blagues-api.fr) accessible depuis une authentification discord
...
fetch('https://blagues-api.fr/api/random', {
    headers: {
...
- Site web: <a href="https://blagues-api.fr" target="_blank">`blagues-api.fr`</a>
